...
public class SysDataConnectController extends BaseApiService {
  ...
  public ResponseBase testConnection(@RequestBody SysDataConnect dataConnect){
  ...
  public ResponseBase add_database( @RequestBody SysDataConnect dataConnect) {
    // 先进行链路测试
    if (!iDataConnectService.testConnection(dataConnect)) {
      return setResultError("链路不通！！！");
    }
  ...
  @PostMapping("/edit")
  public ResponseBase edit(@RequestBody SysDataConnect dataConnect) {
